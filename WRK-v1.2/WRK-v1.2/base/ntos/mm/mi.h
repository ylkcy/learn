...
typedef struct _MMPFN {
    ...
    union {
        ...
        struct {
            USHORT ReferenceCount; //被引用的次数
            MMPFNENTRY e1;         //表示物理页的状态  
        };
        struct {
